use crate::{consensus::{basic::TestConsensusError, ConsensusError}, identity::{
    state_transition::{
...
}, prelude::IdentityPublicKey, state_transition::{StateTransitionConvert, StateTransitionIdentitySigned}, tests::{
    fixtures::{
        get_identity_update_transition_fixture, get_protocol_version_validator_fixture,
    },
    utils::get_schema_error,
}, util::json_value::JsonValueExt, validation::SimpleValidationResult, version::ProtocolVersionValidator, NonConsensusError, NativeBlsModule};
...
fn setup_test() -> TestData {
    ...
    TestData {
        ...
        public_keys_signatures_validator: PublicKeysSignaturesValidator::new(NativeBlsModule::default())
    }
}
