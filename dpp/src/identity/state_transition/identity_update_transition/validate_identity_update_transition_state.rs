    ...
    SR: StateRepositoryLike,
{
    ...
    pub async fn validate(
        ...
        // Check revision
        if identity.get_revision() as u64 != state_transition.get_revision() - 1 {
        ...
        for key_id in state_transition.get_public_key_ids_to_disable().iter() {
            ...
            identity
                ...
                .unwrap()
                .disabled_at = Some(state_transition.get_public_keys_disabled_at());
        }
        ...
        let disabled_at_time = state_transition.get_public_keys_disabled_at();
