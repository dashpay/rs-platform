...
fn test_query_historical() {
    ...
    assert_eq!(
        ...
        vec![
            128, 252, 179, 97, 131, 69, 233, 41, 120, 123, 206, 12, 233, 7, 10, 212, 4, 153, 54,
            19, 139, 53, 136, 196, 146, 149, 86, 40, 126, 195, 204, 29
        ]
    );
    ...
    assert_eq!(
        root_hash.expect("cannot get root hash").as_slice(),
        vec![
            220, 80, 43, 153, 39, 129, 179, 35, 207, 139, 92, 252, 122, 36, 16, 181, 87, 4, 102,
            239, 162, 90, 163, 238, 119, 255, 106, 64, 104, 146, 172, 123
        ]
    );
}
