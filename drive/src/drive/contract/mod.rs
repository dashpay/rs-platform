...
mod tests {
    ...
    fn test_create_and_update_contract() {
        ...
        drive
            .apply_contract_cbor(initial_contract_cbor, None, 0f64, true, StorageFlags::default(),  None)
            .expect("expected to apply contract successfully");
        ...
        drive
            .apply_contract_cbor(updated_contract_cbor, None, 0f64, true, StorageFlags::default(), None)
