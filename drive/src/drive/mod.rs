...
mod tests {
    ...
    fn setup_dashpay(_prefix: &str, mutable_contact_requests: bool) -> (Drive, Vec<u8>) {
        ...
        drive
            .apply_contract(dashpay_cbor.clone(), None, 0f64, None)
    ...
    fn test_create_and_update_document_same_transaction() {
        ...
        drive
            .apply_contract(contract_cbor.clone(), None, 0f64, Some(&db_transaction))
            .expect("expected to apply contract successfully");
    ...
    fn test_create_and_update_document_no_transactions() {
        ...
        drive
            .apply_contract(contract_cbor.clone(), None, 0f64, None)
            .expect("expected to apply contract successfully");
    ...
    fn test_create_and_update_contract() {
        ...
        drive
            .apply_contract(initial_contract_cbor, None, 0f64, None)
            .expect("expected to apply contract successfully");
        ...
        drive
            .apply_contract(updated_contract_cbor, None, 0f64, None)
    ...
    fn test_create_update_and_delete_document() {
        ...
        drive
            .apply_contract(contract.clone(), None, 0f64, None)
