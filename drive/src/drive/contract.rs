...
impl Drive {
    ...
    pub fn apply_contract(
        ...
        let key_value_info = match action {
            ItemApply | DryRunFee => Ok(KeyRefRequest(&[0])),
            WorstCaseFeeWithKnownItem => {
                ...
                Ok(KeyValueMaxSize((1, contract_serialization.len())))
            }
            WorstCaseFeeForDocumentType => Err(Error::Drive(DriveError::InvalidActionType(
                "contracts can not use worst case for document type",
            ))),
        }?;
...
mod tests {
    ...
    use crate::contract::Contract;
    use crate::drive::object_size_info::ActionType::{ItemApply, WorstCaseFeeWithKnownItem};
    ...
    fn setup_deep_nested_contract() -> (Drive, Contract, Vec<u8>) {
        ...
        drive
            .apply_contract(&contract, contract_cbor.clone(), 0f64, ItemApply, None)
    ...
    fn test_create_and_update_contract() {
        ...
        drive
            .apply_contract_cbor(initial_contract_cbor, None, 0f64, ItemApply, None)
            .expect("expected to apply contract successfully");
        ...
        drive
            .apply_contract_cbor(updated_contract_cbor, None, 0f64, ItemApply, None)
    ...
    #[test]
    fn test_create_and_update_contract_without_apply() {
        let tmp_dir = TempDir::new().unwrap();
        let drive: Drive = Drive::open(tmp_dir).expect("expected to open Drive successfully");
        ...
        // Create contract with apply

        let initial_contract_cbor = hex::decode("").unwrap();

        let (actual_storage_cost, actual_processing_cost) = drive
            .apply_contract_cbor(initial_contract_cbor.clone(), None, 0f64, ItemApply, None)
            .expect("expected to apply contract successfully");

        // Create contract without apply

        let (predicted_storage_cost, predicted_processing_cost) = drive
            .apply_contract_cbor(initial_contract_cbor, None, 0f64, WorstCaseFeeWithKnownItem, None)
            .expect("expected to apply contract successfully");
        ...
        // Update contract with apply

        let (actual_storage_cost, actual_processing_cost) = drive
            .apply_contract_cbor(updated_contract_cbor.clone(), None, 0f64, ItemApply, None)
            .expect("should update initial contract");

        // Update contract without apply

        let (predicted_storage_cost, predicted_processing_cost) = drive
            .apply_contract_cbor(updated_contract_cbor, None, 0f64, WorstCaseFeeWithKnownItem, None)
            .expect("should update initial contract");
